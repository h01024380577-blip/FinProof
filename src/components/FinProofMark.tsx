export function FinProofMark({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="fp-shield" x1="54" y1="28" x2="160" y2="155" gradientUnits="userSpaceOnUse">
          <stop stopColor="#031B4E" />
          <stop offset="0.58" stopColor="#0A367A" />
          <stop offset="1" stopColor="#0E6BDB" />
        </linearGradient>
        <linearGradient id="fp-check" x1="122" y1="123" x2="178" y2="87" gradientUnits="userSpaceOnUse">
